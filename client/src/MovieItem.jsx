    ...
    const watched = this.props.movie.watched
      return (
        ...
        <div id="movie" className={this.props.lookup} onClick={(e)=> this.props.handleStats(e)}>
          ...
          {watched ? <button id="watched" className={this.props.lookup} onClick={(e) => this.props.handleToggle(e)}>WATCHED</button> : <button id="notwatched" className={this.props.lookup} onClick={(e) => this.props.handleToggle(e)}>NOT WATCHED</button>}
        </div>
